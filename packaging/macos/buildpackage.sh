...
# 10.15 is the floor for every slice: it is the oldest macOS .NET 6 supports, and since the
# Mono variant was dropped there is no longer a runtime that can serve anything older.
