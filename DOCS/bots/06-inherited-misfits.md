...
`structures.yaml:688,756` and `structures-defenses.yaml:91,187,272,692,777,819`; **nothing in `mods/` provides
...
(`structures.yaml:688`, `:756`) — correct under the game model. The aircraft still declare them as rearm hosts
