...
| [`architecture.md`](architecture.md) | Engine layout, scenario system, custom traits, aircraft movement, suppression/stances, AI config, shadows.bin, asset & audio/music pipeline, networking/NAT, saved games, replays & build fingerprint, sync-hash coverage, widget gotchas |
