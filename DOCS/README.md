...
Static project documentation. Two kinds:

- [`skills/`](skills/) — workflow triggers (AUTOTEST, PLAN, RELEASE, …). The agent follows these when the user types the trigger phrase. Index in [`skills/README.md`](skills/README.md).
