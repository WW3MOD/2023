-- DEMO -- does the nuclear fireball still show a brightness seam where it crosses fog?
--
...
-- the map is pre-explored and fog is on, and one indestructible CAMERA six cells west of
-- ground zero lights a disc through the middle of where the fireball will be, so the shipped
-- ten-band vision ramp falls across the cloud.
--
