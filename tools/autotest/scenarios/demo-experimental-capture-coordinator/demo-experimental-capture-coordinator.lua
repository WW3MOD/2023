-- DEMO: experimental CaptureCoordinatorBotModule visible behavior
--
-- LAYOUT
...
--   2. ESCORT — when experimental dispatches an engineer, 1-2 nearby idle infantry
--      should move along with it (attack-move). Normal AI's engineer
--      walks alone.
--   3. DEFENSE — once experimental captures, if Russia army threatens the captured
