...
namespace OpenRA.Traits
{
	...
	[Desc("Cast shadows behind objects")]
	public class ShadowCasterInfo : TraitInfo, ILobbyOptions
	{
		...
		public override object Create(ActorInitializer init) { return new ShadowCaster(init.Self, this); }
	}

    public class ShadowCaster
    {
		readonly ShadowCasterInfo info;
		readonly Map map;

		public ShadowCaster(Actor self, ShadowCasterInfo info)
		{
			this.info = info;
			map = self.World.Map;
		}
