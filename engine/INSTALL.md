...
.NET 6 is required to compile OpenRA. Mono is no longer supported.

The [.NET 6 download page](https://dotnet.microsoft.com/download/dotnet/6.0) provides repositories for various package managers and binary releases for several architectures.
...
[.NET 6](https://dotnet.microsoft.com/download/dotnet/6.0) is required to compile OpenRA. Mono is no longer supported, so macOS 10.15 (the .NET 6 floor) is the oldest supported version.
