...
namespace OpenRA.Mods.Cnc.Traits
{
	...
	class Tree : ICrushable, INotifyCrushed
	{
		readonly TreeInfo info;
		...
		void INotifyCrushed.OnCrush(Actor self, Actor crusher, BitSet<CrushClass> crushClasses)
		{
			...
			// if (crusher.Info.HasTraitInfo<TreeTraversableInfo>() || (self.Owner.RelationshipWith(crusher.Owner) == PlayerRelationship.Ally && info.AvoidFriendly))
			// 	return;
	...
	[Desc("Tag trait for stuff that should not trigger Trees.")]
	class TreeTraversableInfo : TraitInfo<TreeTraversable> { }
	class TreeTraversable { }
}
