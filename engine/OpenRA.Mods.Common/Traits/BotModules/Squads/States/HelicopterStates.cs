...
namespace OpenRA.Mods.Common.Traits.BotModules.Squads
{
	...
	class HelicopterIdleState : HelicopterStateBase, IState
	{
		...
		public void Tick(Squad owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new HelicopterApproachState(), true);
		}
	...
	class HelicopterApproachState : HelicopterStateBase, IState
	{
		...
		public void Tick(Squad owner)
		{
			...
			if (ShouldFlee(owner))
			{
				owner.FuzzyStateMachine.ChangeState(owner, new HelicopterReturnState(), true);
				return;
			}

			if (!owner.IsTargetValid)
			{
				owner.FuzzyStateMachine.ChangeState(owner, new HelicopterIdleState(), true);
				return;
			}
			...
			if (IsTargetTooHot(owner, owner.TargetActor.CenterPosition))
			{
				...
				{
					owner.FuzzyStateMachine.ChangeState(owner, new HelicopterWithdrawState(), true);
					return;
				}
			}
			...
			{
				owner.FuzzyStateMachine.ChangeState(owner, new HelicopterAttackRunState(), true);
				return;
			}
