...
{
	public abstract class AffectsRadarInfo : ConditionalTraitInfo
	{
	...
	public abstract class AffectsRadar : ConditionalTrait<AffectsRadarInfo>, ISync, INotifyAddedToWorld,
		INotifyRemovedFromWorld, INotifyMoving, INotifyVisualPositionChanged, ITick
	{
		...
		void UpdateRadarCells(Actor self)
		{
			var cells = ProjectedCells(self);
			foreach (var p in self.World.Players)
			{
				RemoveCellsFromPlayerRadar(self, p);
				AddCellsToPlayerRadar(self, p, cells);
			}
		}
