...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class MapOptionsInfo : TraitInfo, ILobbyOptions, IRulesetLoaded
	{
		...
		{
			yield return new LobbyBooleanOption("shortgame",
			...
			if (techLevels.Count > 0)
				yield return new LobbyOption("techlevel",
			...
			yield return new LobbyOption("gamespeed",
				GameSpeedDropdownLabel, GameSpeedDropdownDescription,
				GameSpeedDropdownVisible, GameSpeedDropdownDisplayOrder,
				new ReadOnlyDictionary<string, string>(speeds),
