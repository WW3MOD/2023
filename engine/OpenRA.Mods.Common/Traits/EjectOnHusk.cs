...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class EjectOnHuskInfo : ConditionalTraitInfo
	{
		[ActorReference]
		...
		public override object Create(ActorInitializer init) { return new EjectOnHusk(this); }
	}

	public class EjectOnHusk : ConditionalTrait<EjectOnHuskInfo>, INotifyCreated
	{
		public EjectOnHusk(EjectOnHuskInfo info)
			: base(info) { }

		void INotifyCreated.Created(OpenRA.Actor self)
		{
