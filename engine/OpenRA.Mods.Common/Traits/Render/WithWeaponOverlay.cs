...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithWeaponOverlayInfo : PausableConditionalTraitInfo, IRenderActorPreviewSpritesInfo, Requires<RenderSpritesInfo>, Requires<BodyOrientationInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new WithWeaponOverlay(init.Self, this); }
	...
	public class WithWeaponOverlay : PausableConditionalTrait<WithWeaponOverlayInfo>
	{
		readonly Animation overlay;

		public WithWeaponOverlay(Actor self, WithWeaponOverlayInfo info)
			: base(info)
		{
			...
			overlay = new Animation(self.World, rs.GetImage(self), () => self.Orientation.Yaw, () => IsTraitPaused)
			{
