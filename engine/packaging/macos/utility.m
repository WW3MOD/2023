...
// WW3MOD: the Mono dispatch was removed here, matching launcher.m. The bundle no longer
// contains a mono/ assembly slice or the checkmono helper, so that path looked for files the
// packaging does not build. Info.plist sets LSMinimumSystemVersion 10.15, the .NET 6 floor,
// so no supported OS reaches the case that used to need Mono.
