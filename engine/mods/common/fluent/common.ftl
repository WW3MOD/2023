...
notification-no-port-forward-discovery-disabled = Server port is not accessible from the internet. Automatic port forwarding is switched off — enable UPnP/NAT-PMP discovery in Settings, Advanced, or forward the port on your router by hand.
