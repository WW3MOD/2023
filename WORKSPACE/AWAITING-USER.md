...
> - `MainMenuLogic.cs:280` — `"WW3MOD — Pre-Alpha"`, the main-menu **i** dropdown (`mainmenu.yaml:87` button, `:101` panel, `:109` label). **This is the live one — the only place a player ever reads the string.**
