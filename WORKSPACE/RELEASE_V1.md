...
- [ ] **Helicopter→helicopter missiles silently vanish on impact** — should `FlyStraightIfMiss` past target. `Missile.cs`. Possibly same root cause as WGM mid-flight loss
