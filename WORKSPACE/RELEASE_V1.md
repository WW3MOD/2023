...
- [~] **AI overhaul** — foundation doc 260511 (`WORKSPACE/ai/archive/foundation_260511.md`) — 3-layer brain (Perception/Strategy/Tactics), 5 phases. Tiers 0–3.1 from 260321 stay as executors. **Tournament harness shipped overnight 260511→260512 (~20 commits prefixed `ai: tournament`)**: dual `ModularBot@normal/@v2`, IMatchScorer/IWinRuleEvaluator plug-ins, full score formula (army+kills+income), deterministic seeds, 8× SpeedMultiplier, framerate cap, mirror-paired benchmarks, autonomous loop scaffold. **READ FIRST:** `WORKSPACE/ai/archive/WAKEUP_CHECKLIST_260512.md`. Phase 2+ AI work (the actual brain) still unstarted
